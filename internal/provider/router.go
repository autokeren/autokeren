...
func IsContextLimit(err error) bool {
	...
	return strings.Contains(message, "context length") || strings.Contains(message, "context window") || strings.Contains(message, "context limit") || strings.Contains(message, "context penuh") || (strings.Contains(message, "8007") && strings.Contains(message, "context"))
}
